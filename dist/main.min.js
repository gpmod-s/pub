(function(){
(()=>{const a=({pos:l,prevPos:m})=>l!==m,b=({minScale:l,maxScale:m,scale:p})=>p<=m&&p>=l,c=({minScale:l,maxScale:m,scale:p})=>({pos:r,prevPos:n,translate:q})=>b({minScale:l,maxScale:m,scale:p})&&a({pos:r,prevPos:n})?q+(r-n*p)*(1-1/p):q,d=({scale:l,minScale:m,maxScale:p,scaleSensitivity:r,deltaScale:n})=>[l,Math.max(m,Math.min(l+n/(r/l),p))],e=({scale:l,translateX:m,translateY:p})=>`matrix(${l}, 0, 0, ${l}, ${m}, ${p})`,f=({state:l,originX:m,originY:p})=>{l.transformation.translateX+=m;l.transformation.translateY+=
p;l.element.style.transform=e({scale:l.transformation.scale,translateX:l.transformation.translateX,translateY:l.transformation.translateY})},g=l=>({panBy:({originX:m,originY:p})=>f({state:l,originX:m,originY:p}),panTo:({originX:m,originY:p,scale:r})=>{l.transformation.scale=r;f({state:l,originX:m-l.transformation.translateX,originY:p-l.transformation.translateY})}}),h=l=>({zoom:({x:m,y:p,deltaScale:r,scaleSensitivity:n})=>{const {left:q,top:t}=l.element.getBoundingClientRect(),{minScale:v,maxScale:B,
defaultScaleSensitivity:u}=l,[w,x]=d({scale:l.transformation.scale,deltaScale:r,minScale:v,maxScale:B,scaleSensitivity:n||u});r=m-q;n=p-t;p=r/w;m=n/w;const y=c({scale:w,minScale:v,maxScale:B});r=y({pos:r,prevPos:l.transformation.originX,translate:l.transformation.translateX});n=y({pos:n,prevPos:l.transformation.originY,translate:l.transformation.translateY});l.element.style.transformOrigin=`${p/l.containerScale}px ${m/l.containerScale}px`;l.element.style.transform=e({scale:x,translateX:r/l.containerScale,
translateY:n/l.containerScale});l.transformation={originX:p,originY:m,translateX:r,translateY:n,scale:x}}}),k=l=>({getScale:()=>+l.transformation.scale,setScale:m=>{l.transformation.scale=+m},getScaleSensitivity:()=>+l.defaultScaleSensitivity,setScaleSensitivity:m=>{l.defaultScaleSensitivity=+m},setMinScale:m=>{l.minScale=+m},setMaxScale:m=>{l.maxScale=+m},getMinScale:()=>+l.minScale,getMaxScale:()=>+l.maxScale,setContainerScale:m=>{l.containerScale=+m},reset:()=>{f({state:l,originX:0-l.transformation.translateX,
...
{id:4,name:"GPPainter_"},{id:11,name:"GPGlobalBanlist_",required:!0}],this,c)}const b={author:"liliezzzz",name:"gp-mod",version:"10.3.9",changelogURL:"https://discord.com/channels/929715202600095775/953145081471324270/1190732179609759775",summaryURL:"https://discord.com/channels/929715202600095775/929715202600095778/1190932624340947014",updateNoticeFlag:"false",updateNoticeText:"",discordURL:"https://discord.gg/xxtCmzt8uA",donateURL:"https://boosty.to/gpmod"};if(function(){return navigator?.userAgentData?.brands.some(d=>
...
location.reload()});c.addEventListener("auxclick",f=>{f.preventDefault()});d.appendChild(c);const e=new Set;Array.from(a.values()).forEach((f,g)=>{var h=`${f.url}?${Date.now()}.user.js`;const k=document.createElement("div");k.className="oudated-script_";var l=document.createElement("div");l.textContent=f.name;k.appendChild(l);l=document.createElement("div");l.textContent=`${f.version} \u2794 ${f.latestVersion}`;k.appendChild(l);l=document.createElement("div");k.appendChild(l);const m=document.createElement("a");
m.className="script-update-link_";m.href=h;m.target="_blank";m.textContent=this.l.UPDATE_SCRIPT_LBL;h=p=>{e.add(g);e.size>=a.size&&d.classList.add("shown_");m.closest(".oudated-script_").classList.add("clicked_");"click"===p.type&&(this.updateScript(f.name),p.preventDefault())};m.addEventListener("click",h);m.addEventListener("auxclick",h);l.appendChild(m);b.appendChild(k)});b.appendChild(d);return b}getVersion(){return this.version}getWindowsInkWarningState(){return this.s.windowsInkWarning}setWindowsInkWarningState(a){this.s.windowsInkWarning=
...
(f.data=this.getPlaceholder(g),b=!0));return f})));return[a,b]}getPlaceholder(a){return this.isForgery(a)?GPAssets_.AC_FORGERY_PH[this.l.lang]??Object.values(GPAssets_.AC_FORGERY_PH)[0]:GPAssets_.AC_SUSPICIOUS_PH[this.l.lang]??Object.values(GPAssets_.AC_SUSPICIOUS_PH)[0]}getTriggers(a,b,c){let d=this.itemsTriggers.get(a);d||(d=this.calcTriggers(b,c),this.itemsTriggers.set(a,d),d.size&&this.isSubscribed&&this.suspiciousItems.add(a));return d}calcTriggers(a,b){const c=new Set;var d=a.findLastIndex(q=>
11===q[0]);a=a.slice(d+1);if(!a?.length)return c;const {animate:e}=this.gpproxy.getGameConfig();let f=0;var g=0;let h=null,k=null,l=0,m=0;d=[];let p=[],r=0,n=0;for(let q=0;q<a.length;q++){const t=a[q],v=t[0];if(b&&this.isMStroke(t)){const {code:B,author:u}=this.decodeMStroke(t);B!==this.gpproxy.getGameCode()&&c.add(20);u!==this.gpproxy.formatNickname(b)&&c.add(21)}if(1===v){1===e&&2===t[2][1]&&4===t.length&&f++;const B=t.length-3,[u,w]=t[3];u===h&&3>B?l++:(l>GPAntiCheat_.SEQUENCE_MIN_SIZE&&(r=Math.max(r,
l),d.push(l)),l=0);w===k&&3>B?m++:(m>GPAntiCheat_.SEQUENCE_MIN_SIZE&&(n=Math.max(n,m),p.push(m)),m=0);h=u;k=w}else 8===v&&g++;1!==v&&(h=k=null,l=m=0)}b=f/a.length*100;g=g/a.length*100;a.length>=GPAntiCheat_.MIN_STROKES_TRIGGER&&(b>GPAntiCheat_.MIN_PERCENTAGE_TRIGGER||g>GPAntiCheat_.MIN_PERCENTAGE_TRIGGER)&&c.add(1);(d.length>GPAntiCheat_.SEQUENCES_COUNT_TRIGGER||p.length>GPAntiCheat_.SEQUENCES_COUNT_TRIGGER)&&c.add(2);(r>GPAntiCheat_.MAX_SEQUENCE_TRIGGER||n>GPAntiCheat_.MAX_SEQUENCE_TRIGGER)&&c.add(3);
...
meta:g}=b;var h=GPArtBroadcaster_.SENT_IMAGE_DENSITY;const k=GPArtBroadcaster_.SENT_IMAGE_ORIGINAL_WIDTH*h,l=GPArtBroadcaster_.SENT_IMAGE_ORIGINAL_HEIGHT*h,m=document.createElement("canvas");m.width=k;m.height=l;var p=m.getContext("2d");p.fillStyle=GPArtBroadcaster_.SENT_IMAGE_BACKGROUND_COLOR;p.fillRect(0,0,k,l);f&&this.drawFunction(p,f,h,!1);p=document.createElement("canvas");p.width=k;p.height=l;var r=p.getContext("2d");this.drawFunction(r,e,h,!0);h=document.createElement("canvas");h.width=k;h.height=
l;r=h.getContext("2d");r.drawImage(m,0,0,k,l);r.drawImage(p,0,0,k,l);h.toBlob(async n=>{d.classList.remove("complete_");d.classList.add("uploading_");var q=(new Date(g.date)).toLocaleDateString("ru-RU");q=`${g.author} - ${g.title} (${q})`;n=new File([n],`${q}.png`);const t=await GPUtils_.compressImageData(b);q=new File([t],`${q}.gpimg`);document.dispatchEvent(new CustomEvent("_send_to_media",{detail:{services:a,artFile:n,sourceFile:q,meta:g,authType:this.gpproxy.authType,albumId:this.gpproxy.getCurrentAlbumId(),
...
const g=a.scale;a.scale=function(n,q){c=c.scaleNonUniform(n,q);return g.call(a,n,q)};const h=a.rotate;a.rotate=function(n){c=c.rotate(180*n/Math.PI);return h.call(a,n)};const k=a.translate;a.translate=function(n,q){c=c.translate(n,q);return k.call(a,n,q)};const l=a.transform;a.transform=function(n,q,t,v,B,u){const w=b.createSVGMatrix();w.a=n;w.b=q;w.c=t;w.d=v;w.e=B;w.f=u;c=c.multiply(w);return l.call(a,n,q,t,v,B,u)};const m=a.setTransform;a.setTransform=function(n,q,t,v,B,u){c.a=n;c.b=q;c.c=t;c.d=
v;c.e=B;c.f=u;return m.call(a,n,q,t,v,B,u)};const p=a.resetTransform;a.resetTransform=function(){c=b.createSVGMatrix();d.length=0;return p.call(a)};const r=b.createSVGPoint();a.transformedPoint=function(n,q){r.x=n;r.y=q;return r.matrixTransform(c.inverse())}}setImage(a){this.image=a;this.reset()}setScaleFactor(a){this.scaleFactor=a}mirror(){this.image&&(this.ctx.translate(this.canvas.width,0),this.ctx.scale(-1,1),this.ctx.drawImage(this.image,0,0),this.redraw())}};class GPAlbumObserver_{static MONITOR_INTERVAL=200;static ITEM_TYPE={IMAGE:"image",TEXT:"text",ANIMATION:"animation",MULTI_PIECE:"multi-piece",AI_IMAGE:"ai-image"};constructor(a){if(GPAlbumObserver_.instance)return GPAlbumObserver_.instance;GPAlbumObserver_.instance=this;this.gpproxy=a;this.isInitialized=!1;this.monitorTimer;this.inObserving=!1;this.nextItemId=null;this.items=[];this.endTitle=this.title=null;this.observerConfig={childList:!0,subtree:!0};this.observer=new MutationObserver(this.observerCallback.bind(this));
...
{this.updateTwitchIdsCache(d)});this.gpproxy.addEventListener("data",({detail:{event:d}})=>{d===GPProxy_.EVENT.GALLERY_SETTINGS&&this.reportedItems.clear()})}async send({itemId:a,albumId:b,...c}){var d=`${b}_${a}`;if(!this.reportedItems.has(d)){this.reportedItems.add(d);var e=this.gpproxy.getAlbumItem(a,b);if(e){var {first:f,turns:g,animate:h,keep:k}=this.gpproxy.getGameConfig();d={first:f,turns:g,animate:h,keep:k};var {authId:l,nick:m}=this.gpproxy.getUser(),{meta:{author:p,title:r,date:n},data:q,
type:t}=e,v=(new Date(n)).toLocaleDateString("ru-RU"),B=t===GPImageReportSender_.ITEM_TYPE.IMAGE;switch(t){case GPImageReportSender_.ITEM_TYPE.IMAGE:var u=`${p} - ${r} (${v})`;v=await GPUtils_.compressImageData(e);u=new File([v],`${u}.gpimg`);break;case GPImageReportSender_.ITEM_TYPE.TEXT:u=`${p} - ${q} (${v})`,v=new Blob([q],{type:"text/plain"}),u=new File([v],`${u}.txt`)}v=Object.keys(GPProxy_.AUTH_TYPE_IDS).find(x=>GPProxy_.AUTH_TYPE_IDS[x]===e.auth);var w=this.gpproxy.isTwitchAuth()?this.twitchIdsCache.get(p.toLowerCase())??
null:null;document.dispatchEvent(new CustomEvent(this.eventType,{detail:{noticeColor:this.noticeColor,author:p,authorId:w,sender:m,senderId:l,itemData:e,sourceFile:u,service:v,itemId:a,albumId:b,isImage:B,gameCode:this.gpproxy.getGameCode(),gameConfig:d,keyHash:this.keyHash,...c}}))}}}updateTwitchIdsCache(a){a.forEach((b,c)=>{this.twitchIdsCache.set(b,c)})}}window.GPImageReportSender_=GPImageReportSender_;class GPLocalization_{static MISSING_STR="N/A";static DEFAULT_DATA={lang:"ru",entries:{}};constructor(a=GPLocalization_.DEFAULT_DATA){this.lang=a.lang;this.entries=this.initEntries(a.entries)}get(a){return this.entries[a]}getLang(){return this.lang}initEntries(a={}){return new Proxy(a,{get:(b,c)=>new Proxy(b[c]??{},{get:(d,e)=>"lang"===e?this.lang:d[e]??GPLocalization_.MISSING_STR})})}};class GPUtils_{static async compressImageData(a,b=!0){const {data:c,background:d,auth:e,meta:f}=a;a={m:{a:f.author,t:f.title,d:(new Date(f.date)).toISOString()},d:c};d&&(a.b=d);e&&(a.a=e);return b?this.wCompressData(a):this.compressData(a)}static async compressData(a){a=JSON.stringify(a);a=this.stringToArrayBuffer(a);a=await this.compressArrayBuffer(a);return this.arrayBufferToBlob(a)}static arrayBufferToBlob(a){return new Blob([a],{type:"octet/stream"})}static async compressArrayBuffer(a){var b=
...
ke:c.e??null,kg:Number(c.g??!1),km:Number(c.m??!1),at:d,af:Number(e)}}))});document.addEventListener("_auth_id",async({detail:{authId:c,authTypeId:d,isAuthorized:e}})=>{function f(n){this.lm=this.lm.filter(q=>1<<q.id&n?(q.disabled||q.initialized||this.initModuleInstance(q,this.root,this.loc.get(q.name)),q.locked=!1):q.locked=!0);this.renderModulesList()}async function g(n,q){q=(new TextEncoder).encode(q);var t=await crypto.subtle.digest("SHA-256",q);q=window.atob(n).slice(0,12);q={name:"AES-GCM",
iv:new Uint8Array(Array.from(q).map(v=>v.charCodeAt(0)))};t=await crypto.subtle.importKey("raw",t,q,!1,["decrypt"]);n=window.atob(n).slice(12);n=new Uint8Array(Array.from(n).map(v=>v.charCodeAt(0)));try{const v=await crypto.subtle.decrypt(q,t,n);return(new TextDecoder).decode(v)}catch(v){throw new GPDecryptError_;}}function h(n){document.dispatchEvent(new CustomEvent("_auth_perms",{detail:{ps:n}}))}async function k(n){n=await g(n,l());return fetch("https://id.twitch.tv/oauth2/validate",{headers:{Authorization:`OAuth ${n}`},
credentials:"omit",cache:"no-cache"}).then(q=>{if(q.ok)return q.json();throw Error();}).then(q=>[q.user_id,q.login]).catch(()=>[])}function l(){function n(x,y){const z=q();return n=function(C,L){C-=195;let I=z[C];void 0===n.IvNImK&&(n.biwoho=function(E){let D="",G="";for(let H=0,K,J,M=0;J=E.charAt(M++);~J&&(K=H%4?64*K+J:J,H++%4)?D+=String.fromCharCode(255&K>>(-2*H&6)):0)J="abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789+/=".indexOf(J);for(let H=0,K=D.length;H<K;H++)G+="%"+("00"+D.charCodeAt(H).toString(16)).slice(-2);
return decodeURIComponent(G)},x=arguments,n.IvNImK=!0);const A=C+z[0],F=x[A];return F?I=F:(I=n.biwoho(I),x[A]=I),I},n(x,y)}function q(){const x="mZmYvMvlr1vW yxrVyG ndq1mJu4offSB0n4Aa mJqZnZKYvwvXC0TJ yJnoAMni uNbIv1zhyJnkDa vMHAmLu9 yuDgEvPi zgHKrZL5 EeLAv2XUyuHrpq yKDgDvOZ mJmZmtvWze92EgO EdjAv1jqy0HsCa uKDgmfPw BwfW mJm0BNnKqvHr zfHoBgnR yvCXmwjb nZyYmZG4ohvMwM96ra rM5AvZuWuKDgma zgHJBvzeyJi1AG sw50Ba nM9RwxbMEq mJCZody2mhjjweLLrq y21wEMiY y0D4Agrh wvHrpq mZu3m1nVA1f5Bq zeDSDfPw wvHAAgfx wKDwmMfx y2HHCKnVzgvbDa mZy4mZCXu1LtDvvr yM1gmMfx".split(" ");
q=function(){return x};return q()}(function(x,y){const z=n;for(x=x();;)try{if(parseInt(z(219))/1+parseInt(z(202))/2*(-parseInt(z(214))/3)+-parseInt(z(221))/4*(-parseInt(z(198))/5)+parseInt(z(209))/6*(parseInt(z(223))/7)+-parseInt(z(205))/8+-parseInt(z(224))/9+parseInt(z(210))/10===y)break;else x.push(x.shift())}catch(C){x.push(x.shift())}})(q,545929);const t=n,v=[t(220)+t(195),t(203)+(t(206)+"YQ=="),"","",t(212)+"Zvcm0=",t(228)+(t(207)+"dXJyZW5jeQ=="),"c2NyZWVu",t(216)+"xXaWR0aA==","YXZhaW"+t(196),
t(197)+t(227),"",t(225)+"U=",t(217)+"NlTWVtb3J5",t(200)+(t(226)+t(213)),t(211)+(t(199)+"b25z"),t(215)+"pvbmU=",t(204)+"=="][t(201)](window[t(222)]),B=JSON.stringify([window[v[0]][v[1]]?.[v[4]],window[v[0]][v[5]],window[v[6]][v[7]],window[v[6]][v[8]],window[v[0]][v[9]],window[v[0]][v[4]],window[v[0]][v[11]],window[v[0]][v[12]],(new (window[t(208)]?.[v[13]]))[v[14]]()[v[15]]]);let u=-559038803,w=1103547925;for(let x=0,y;x<B.length;x++)y=B[t(218)](x),u=Math[v[16]](u^y,2654435761),w=Math[v[16]](w^y,1597334677);
return u=Math[v[16]](u^u>>>16,2246822507)^Math[v[16]](w^w>>>13,3266489909),w=Math[v[16]](w^w>>>16,2246822507)^Math[v[16]](u^u>>>13,3266489909),String(4294967296*(2097151&w)+(u>>>0))}if(this.s.allowAnalytics){var m={};if(this.lm.length){var p=GPModulesManager_.DEFAULT_PERMISSIONS,r=null;try{if(!a||!this.publicKey)throw new GPAuthError_;if(!d)if(this.s.twitchAuth){d=1;const [t,v]=await k(this.s.twitchAuth);if(c=t)this.root.gpproxy.setTwitchOAuth(v);else throw this.s.twitchAuth=null,this.saveSettings(),
this.root.abt?.showTwitchOAuthTokenNotice({onButtonClick:()=>{this.requestTwitchToken()}}),new GPAuthError_;}else throw new GPAuthError_;const n=1===d?"t":"d";m=JSON.parse(await g(a,this.publicKey));const q=JSON.parse(await g(m[n],c));m.e&&this.setEditionTitle(m.e,m.m);m.g&&(r=[GPModulesManager_.ICON.GIFT]);if(q.ed){if(q.ed<Date.now())throw r=[GPModulesManager_.ICON.EXPIRED],2&q.p&&(p|=16),new GPAuthError_;r=[GPModulesManager_.ICON.TIME_LEFT,q.ed-Date.now()]}else m.g||(r=[GPModulesManager_.ICON.SUBSCRIPTION]);
r&&this.setEditionState(...r);f.call(this,p|q.p);h.call(this,p|q.p);this.renderModulesList()}catch(n){n instanceof GPAuthError_||n instanceof GPDecryptError_||console.error(n),e?r??=[GPModulesManager_.ICON.SUBSCRIBE]:this.publicKey&&(r=[GPModulesManager_.ICON.AUTH]),r&&this.setEditionState(...r),f.call(this,p),h.call(this,p)}}this.dispatchEvent(new CustomEvent("modules-loaded",{detail:{decryptedData:m,authTypeId:d,isAuthorized:e}}))}else this.setEditionState(GPModulesManager_.ICON.ANALYTICS),this.root.abt?.showAnalyticsNotice()});
...
document.body.appendChild(l),window.gpSettingsTooltip=l);l.textContent=this.loc.get(c.name).DESCRIPTION;const {x:m,y:p,width:r,height:n}=k.target.getBoundingClientRect();({height:k}=l.getBoundingClientRect());l.style.cssText=`top: ${p-(k-n)/2}px; left: ${m+r+12}px`;window.gpSettingsTooltip=l});e.addEventListener("pointerleave",k=>{window.gpSettingsTooltip&&(window.gpSettingsTooltip.remove(),window.gpSettingsTooltip=null)});f.appendChild(e);e=document.createElement("div");e.className="name_";e.title=
...
!!g);h.toggleAttribute("disabled",!!c.required);h.addEventListener("change",k=>{c.required||(k.target.checked&&this.disabledList.has(c.name)?(c.disabled=!1,this.disabledList.delete(c.name)):(c.disabled=!0,this.disabledList.add(c.name)),this.saveSettings(),this.compareToInitialState())});e.appendChild(h);g=document.createElement("label");g.className="gp-ui-cb-label_";g.setAttribute("for",`module-${d}_`);e.appendChild(g);f.appendChild(e);a.appendChild(f)}});this.settingsBtn.classList.toggle("hidden",
...
m.title=this.l.RESTORE_BTN_TTL;m.addEventListener("click",()=>{this.restore(a)});h.appendChild(m);m=document.createElement("div");m.className="default-btn_ btn_ gp-ui-btn_";m.textContent=this.l.RESET_BTN_LBL;m.title=this.l.RESET_BTN_TTL;m.addEventListener("click",()=>{this.reset(a)});h.appendChild(m);h=document.createDocumentFragment();for(let r in f)if(m=f[r]??{},this.isLabel(r)){var p=document.createElement("div");p.className="label_";p.textContent=m.text;h.appendChild(p);b.labels.set(m.text,p)}else if(this.isSeparator(r))p=
document.createElement("div"),p.className="separator_",p.classList.toggle(`${m.size}_`,!!m.size),h.appendChild(p);else if(m.type&&!m.hidden)switch(m.type){case "component":p=document.createElement("div");p.className="component_";p.dataset.name=r;p.appendChild(m.getElement());h.appendChild(p);this.setControlStateAndDependents(f,r,e,p);break;case "buttons":const n=document.createElement("div");n.className="buttons_";n.dataset.name=r;m.getButtons().forEach(t=>{t.classList.add("btn_");n.appendChild(t)});
h.appendChild(n);this.setControlStateAndDependents(f,r,e,n);break;default:p=document.createElement("div");p.className="setting_";p.dataset.name=r;const q=this.buildTooltip(m.description);p.appendChild(q);m=this.buildName(r,m.description);p.appendChild(m);m=this.buildControl(f,r,e[r],c,d,e,g);p.appendChild(m);h.appendChild(p);this.setControlStateAndDependents(f,r,e,p)}g.appendChild(h);return{view:b,controls:g}}updateView(a,b=null){b??=a.moduleName;const c=+a.scrollPos;({controls:a}=this.buildView(b,
...
d});b.addEventListener("pointerleave",c=>{window.gpSettingsTooltip&&(window.gpSettingsTooltip.remove(),window.gpSettingsTooltip=null)});return b}buildName(a,b){const c=document.createElement("div");c.className="name_";c.title=b||"";c.textContent=a.split(/(?<![A-Z])(?=[A-Z])|(?=[A-Z]\B)/).join(" ");return c}buildControl(a,b,c,d,e,f,g){const {type:h,args:k,formatter:l,inputTrigger:m,beforeActivation:p}=a[b],r=document.createElement("div");r.className="control_";let n;switch(h){case "switch":n=document.createElement("div");
n.className="gp-ui-switch_";var q=`ctrl-${g.view.dataset.index}-${b}_`;const t=document.createElement("input");t.id=q;t.type="checkbox";t.name=b;t.checked=c;if(p){let A=!1;t.addEventListener("click",async F=>{F.preventDefault();if(!A){if(t.checked&&(A=!0,F=await p(),A=!1,!F))return;requestAnimationFrame(()=>{t.checked=!t.checked;t.dispatchEvent(new Event("change",{bubbles:!0}))})}})}n.appendChild(t);const v=document.createElement("label");v.setAttribute("for",q);n.appendChild(v);r.appendChild(n);
break;case "slider":const {min:B,max:u,step:w,reverse:x}=k;n=document.createElement("input");n.className="gp-ui-slider_";n.type="range";n.min=B;n.max=u;n.step=w;n.value=c;n.name=b;x&&(n.style.direction="rtl");n.addEventListener("input",A=>{y.textContent=l?l(Number.parseFloat(A.target.value)):A.target.value});const y=document.createElement("div");y.className="gp-ui-slider-preview_";y.textContent=l?l(c):c;y.addEventListener("pointerdown",A=>{let F=A.clientY;const E=D=>{var G=D.clientY-F;const H=0>G;
Math.abs(G)>=GPSettingsManager_.POINTER_SLIDER_PREVIEW_CHANGE_SENSITIVITY&&(G=n.valueAsNumber,G+=(x?!H:H)?w:-w,G=Math.max(Math.min(G,u),B),G=Math.round(1E3*G)/1E3,n.value=G,y.textContent=l?l(G):G,n.dispatchEvent(new Event("change",{bubbles:!0})),F=D.clientY)};A.currentTarget.setPointerCapture(A.pointerId);A.currentTarget.addEventListener("pointermove",E);A.currentTarget.addEventListener("pointerup",D=>{D.currentTarget.removeEventListener("pointermove",E);n.focus()},{once:!0})});r.appendChild(n);r.appendChild(y);
break;case "input":q=k?.secure;n=document.createElement("input");n.className="gp-ui-input_";n.classList.toggle("secure-input_",!!q);n.spellcheck=!1;n.autocomplete="off";n.value=c;n.name=b;n.addEventListener("keydown",A=>{switch(A.key){case "Escape":A.target.value=A.target.dataset.initialValue;case "Enter":A.target.blur()}});n.addEventListener("focus",A=>{A.target.dataset.initialValue=A.target.value});n.addEventListener("blur",A=>{delete A.target.dataset});GPUtils_.setInputFocusBlurHandler(n);r.appendChild(n);
break;case "dropdown":n=document.createElement("select");n.className="gp-ui-dropdown_";n.autocomplete="off";n.name=b;const {items:z,itemsProxySetting:C}=k;(C&&f[C]||(z?.length?z:[c])).forEach((A,F)=>{const E=document.createElement("option");E.value=A;E.textContent=l?l(A,F):A;n.appendChild(E)});n.value=c;r.appendChild(n);break;case "list-ms":case "list-md":q="list-ms"===h?k.items:c;n=document.createElement("form");n.className="gp-ui-list-m_";n.name=b;q.forEach((A,F)=>{const E=`ctrl-${g.view.dataset.index}-${b}-${F}_`;
var D=document.createElement("input");D.id=E;D.type="checkbox";D.value=A;D.name=b;D.checked=c.includes(A);n.appendChild(D);D=document.createElement("label");D.textContent=l?l(A,F):A;D.setAttribute("for",E);n.appendChild(D)});r.appendChild(n);break;case "list-i":const {icons:L}=k;n=document.createElement("form");n.className="gp-ui-list-i_";n.name=b;const I=[];Object.keys(L).forEach((A,F)=>{F=`ctrl-${g.view.dataset.index}-${b}-${F}_`;const E=document.createElement("input");E.id=F;E.type="checkbox";
E.name=b;E.value=A;E.checked=c===A;E.addEventListener("click",G=>{I.forEach(H=>{H.checked=H===E})});n.appendChild(E);I.push(E);const D=document.createElement("label");D.className="gp-ui-list-i-icon_";D.title=A.split("-").map(G=>G[0].toUpperCase()+G.slice(1)).join(" ");D.style.backgroundImage=`url("${L[A]}")`;D.setAttribute("for",F);n.appendChild(D)});r.appendChild(n);break;case "color":n=document.createElement("input"),n.className="gp-ui-color_",n.type="color",n.value=c,n.name=b,r.appendChild(n)}q=
["change","input"];for(let t=0;t<(m?2:1);t++)n.addEventListener(q[t],v=>{v={[v.target.name]:this.parseValue(v.target,h)};this.dispatchEvent(new CustomEvent("update",{detail:{source:d,storage:e,settings:Object.assign(f,v),changedSettings:v}}));0===t&&this.updateViews(g.view.moduleName,g.view)});n.addEventListener("change",t=>{a[b].dependents&&a[b].dependents.forEach(v=>{this.updateControlState(v,a,f,g)})});return r}updateControlState(a,b,c,d){b[a].requires&&(b=this.calcControlState(b[a],c),d.querySelector(`:scope > [data-name="${a}"]`)?.classList.toggle("disabled_",
...
a[g]*h;return p=>{p=p[g]*h;const r=(p+l-m)*k;0>r?m=p+l:100<r&&(m=p+l-100/k);this.brightness=p=Math.max(.01,Math.min(1,Math.round(r)/100));p=GPColorUtils_.hsvToHex(d,e,p);this.colorPicker.setColor(p);this.dispatchEvent(new CustomEvent("color",{detail:{color:p}}));this.renderPointer(b,c,this.opacity,void 0,!0)}}handKeyDown(a){this.isHand=!0;this.drawingArea.classList.add("hand_");document.addEventListener("keyup",this.handKeyUp,{once:!0})}handKeyUp(a){this.isHand&&(this.drawingArea.classList.remove("hand_"),
...
0,0,d.width,d.height);c.drawImage(this.lastDraw,0,0,d.width,d.height);c.drawImage(this.canvas,0,0,d.width,d.height)}else c=this.canvasCtx;d=this.getPixelColor(a,b);return this.getFillRects(c,a,b,d,this.canvas.width,this.canvas.height).map((e,f)=>4>f%5?Math.round(e/this.density):e)}getFillRects(a,b,c,d,e,f){var g=function(u,w,x){var y=w,z=x;if(m(w,x,u)){for(;m(y+1,z,u);)y++;var C=y;do for(y=w-1,z++;m(y+1,z,u)&&y+1<=C;)y++;while(y==C);return{x:w,y:x,w:C-w,h:--z-x}}return{w:-1,h:-1}},h=function(u,w,
x){var y=w,z=x;if(m(w,x,u)){for(;m(y-1,z,u);)y--;var C=y;do for(y=w+1,z--;m(y-1,z,u)&&y-1>=C;)y--;while(y==C);return{x:C,y:++z,w:w-C,h:x-z}}return{w:-1,h:-1}},k=function(u,w,x){var y=w,z=x;if(m(w,x,u)){for(;m(y,z+1,u);)z++;var C=z;do for(z=x-1,y--;m(y,z+1,u)&&z+1<=C;)z++;while(z==C);return{x:++y,y:x,w:w-y,h:C-x}}return{w:-1,h:-1}},l=function(u,w,x){var y=w,z=x;if(m(w,x,u)){for(;m(y,z-1,u);)z--;var C=z;do for(z=x+1,y++;m(y,z-1,u)&&z-1>=C;)z--;while(z==C);return{x:w,y:C,w:--y-w,h:x-C}}return{w:-1,h:-1}},
m=function(u,w,x){if(r[u][w])return!1;u=4*(u+w*e);u=n.slice(u,u+4);w=Math.abs(x[1]-u[1]);var y=Math.abs(x[2]-u[2]),z=Math.abs(x[3]-u[3]);return 20>Math.abs(x[0]-u[0])&&20>w&&20>y&&20>z||0==u[3]&&255==x[0]&&255==x[1]&&255==x[2]||0==x[3]&&255==u[0]&&255==u[1]&&255==u[2]},p=function(u){for(var w=u[0],x=u[1],y=w+u[2],z=x+u[3];w<y;w++)for(var C=x;C<z;C++)r[w][C]=!0;return u};b=Math.round(b);c=Math.round(c);var r;parseInt(d.replace("#","0x"));!function(){r=[];for(var u=-1;u<=e;u++)r[u]=[];r[-1]=[];r[e]=
[];for(u=-1;u<=f;u++)r[-1][u]=1,r[e][u]=1;for(u=0;u<e;u++)r[u][-1]=1,r[u][f]=1}();var n=a.getImageData(0,0,e,f).data;a=4*(b+c*e);a=[n[a],n[a+1],n[a+2],n[a+3]];d=[];for(var q=0;q<=e;q++)d[q]=[];for(;m(b-1,c,a);)b--;for(;m(b,c-1,a);)c--;var t;q=g(a,b,c);c={x:b,y:c,w:q.w,h:q.h,ref:0,andada:0,stack:0};var v=q.w,B=[].concat(p([q.x,q.y,q.w+1,q.h+1]),[0]);do{b=0;for(2==c.ref&&(b+=c.andada);b<=c.h;)-1!=(t=(q=l(a,c.x+c.w+1,c.y+c.h-b)).h)?(d[t].push({x:q.x,y:q.y,w:q.w,h:q.h,ref:1,andada:c.h+1-b,stack:B.length}),
B.push.apply(B,p([q.x,q.y,q.w+1,q.h+1]).concat([c.stack])),t>v&&(v=t),b+=t):b++;b=0;for(1==c.ref&&(b+=c.andada);b<=c.h;)-1!=(t=(q=k(a,c.x-1,c.y+b)).h)?(d[t].push({x:q.x,y:q.y,w:q.w,h:q.h,ref:2,andada:c.h+1-b,stack:B.length}),B.push.apply(B,p([q.x,q.y,q.w+1,q.h+1]).concat([c.stack])),t>v&&(v=t),b+=t):b++;b=0;for(4==c.ref&&(b+=c.andada);b<=c.w;)-1!=(t=(q=g(a,c.x+b,c.y+c.h+1)).w)?(d[t].push({x:q.x,y:q.y,w:q.w,h:q.h,ref:3,andada:c.w+1-b,stack:B.length}),B.push.apply(B,p([q.x,q.y,q.w+1,q.h+1]).concat([c.stack])),
t>v&&(v=t),b+=t):b++;b=0;for(3==c.ref&&(b+=c.andada);b<=c.w;)-1!=(t=(q=h(a,c.x+c.w-b,c.y-1)).w)?(d[t].push({x:q.x,y:q.y,w:q.w,h:q.h,ref:4,andada:c.w+1-b,stack:B.length}),B.push.apply(B,p([q.x,q.y,q.w+1,q.h+1]).concat([c.stack])),t>v&&(v=t),b+=t):b++;for(c=d[v].pop();null==c&&0<v;)c=d[--v].pop()}while(null!=c);return B}setTimer(){this.timer&&(this.timer.reset(),this.timer.settings.runAfterTurnStart&&this.gpproxy.isGameTime(GPProxy_.GAME_TIME.HOSTS_DECISION)&&this.gpproxy.isHost()&&this.timer.start())}stopTimer(){this.timer&&
...
f=d===e.height?e.height/this.image.naturalHeight:e.width/this.image.naturalWidth,g=Math.round(a.clientX-e.x)/f,h=Math.round(a.clientY-e.y)/f;this.isCropping=!0;var k=(l=>{this.isCropping||this.image.removeEventListener("pointermove",k);const m=Math.min(b,l.pageX),p=Math.min(c,l.pageY),r=Math.max(b,l.pageX);l=Math.max(c,l.pageY);this.cropper.style.left=`${m}px`;this.cropper.style.top=`${p}px`;this.cropper.style.width=`${r-m}px`;this.cropper.style.height=`${l-p}px`}).bind(this);this.image.setPointerCapture(a.pointerId);
...
0),p=f-l,r=g-m;f=Math.abs(h-f)-(Math.max(h-this.image.naturalWidth,0)-l);g=Math.abs(k-g)-(Math.max(k-this.image.naturalHeight,0)-m);k=document.createElement("canvas");k.width=f;k.height=g;k.getContext("2d").drawImage(this.image,p,r,f,g,0,0,f,g);k.toBlob(e)})}onImageMove(a){this.zoomer.panBy({originX:a.movementX,originY:a.movementY})}onImageDblClick(a){this.zoomer.reset();this.updateHistoryState()}onImageWheel(a){a.preventDefault();this.zoomer.zoom({deltaScale:-Math.sign(a.deltaY),x:a.pageX-window.scrollX,
...
(this.fm.width=a,this.dispatchSize(a))}toFront(){this.fm.toFront(this)}moveHandler(a){if(0===a.button){var b=this.frame.dataset.orien,c=this.offsetX,d=this.offsetY,[e,f,g,h]=this.getCoords(a),k=(l=>{const [m,p,r]=this.getStickyCoords(l,l.pageX-e,l.pageY-f,g,h);this.setPosition(m,p,g,h,r)}).bind(this);this.frame.setPointerCapture(a.pointerId);this.frame.addEventListener("pointermove",k);this.frame.addEventListener("pointerup",()=>{this.frame.removeEventListener("pointermove",k);this.isChanged||this.offsetX===
...
c,null];const f=this.fm.stickyEdgesDistance;let g,h,k,l,m=null,p,r;this.fm.getFrames().forEach(n=>{if(n!==this){var q=n.frame.getBoundingClientRect();var t=Math.abs(q.y-(c+e));t<f&&(void 0===k||t<k)&&q.x+q.width>=b&&q.x<=b+d&&(!r||r[0]===n.frame.dataset.orien[0])&&(k=t,c=q.y-e,m=r=n.frame.dataset.orien);t=Math.abs(q.y+q.height-c);t<f&&(void 0===l||t<l)&&q.x+q.width>=b&&q.x<=b+d&&(!r||r[0]===n.frame.dataset.orien[0])&&(l=t,c=q.y+q.height,m=r=n.frame.dataset.orien);t=Math.abs(q.x-(b+d));t<f&&(void 0===
g||t<g)&&q.y+q.height>=c&&q.y<=c+e&&(!p||p[1]===n.frame.dataset.orien[1])&&(g=t,b=q.x-d,m=p=n.frame.dataset.orien);t=Math.abs(q.x+q.width-b);t<f&&(void 0===h||t<h)&&q.y+q.height>=c&&q.y<=c+e&&(!p||p[1]===n.frame.dataset.orien[1])&&(h=t,b=q.x+q.width,m=p=n.frame.dataset.orien)}});return[b,c,m]}resizeHandler(a){if(2===a.button){var b=this.width,c=a.pageX,d=this.image.getBoundingClientRect().width,e=this.frame.dataset.orien,f=(g=>{g=g.pageX-c;this.setSize(Math.min(Math.max(d+(e[1]===GPReferenceFrame_.ORIENTATION.LEFT?
...
this.originalData=a.slice();const [m,p,r]=this.handleDelimiters(a,b);this.data=m;this.background=p;this.auth=c;this.author=d;this.title=e;this.date=new Date(f);this.eraserAlpha=!r;this.fi=f&&this.date.getTime()>GPTimelapsePlayer_.FV2_DATE?5:4;this.container=g;this.container.isPlayerRendered=!0;this.mainContainer=h;this.defaultDisplayMode=k;this.defaultDisplayModeDensity=this.getModeDensity(k);this.cache;this.canvas;this.ctx;this.isPlaying=!1;this.currentSpeed=JSON.parse(localStorage.getItem("gp-timelapse-player-speed"))||
